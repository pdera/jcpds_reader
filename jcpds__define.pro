...
;
;+
;Plus all my silly get and set functions to modify things
...
;;;; This area just has get functions for specific variables
function jcpds::get_comment
...
function jcpds::get_a
	return, self.a
end
function jcpds::get_b
	return, self.b
end
function jcpds::get_c
	return, self.c
end
function jcpds::get_alpha
	return, self.alpha
end
function jcpds::get_beta
	return, self.beta
end
function jcpds::get_gamma
	return, self.gamma
end
function jcpds::get_K0
	return, self.k0
end
function jcpds::get_KP
	return, self.k0p
end
function jcpds::get_k0dt
	return, self.dk0dt
end
function jcpds::get_kpdt
	return, self.dk0pdt
end
function jcpds::get_v
	return, self.v
end

;;;; This area just has set procedures for specific variables
pro jcpds::set_comment,new
	self.pcomment=ptr_new('')
	*self.pcomment=new

end

pro jcpds::set_hkl,new
	sz=size(new,/n_elements)
	self.preflection=ptr_new(new)
	*self.pcomment=new
end
...
pro jcpds::set_alpha,new
	self.alpha=new
end
pro jcpds::set_beta,new
	self.beta=new
end

pro jcpds::set_gamma,new
	self.gamma=new
end

pro jcpds::set_k0,new
	self.k0=new
end

pro jcpds::set_kp,new
	self.k0p=new
end
pro jcpds::set_k0dt,new
	self.dk0dt=new
end

pro jcpds::set_kpdt,new
	self.dk0pdt=new
end
...
function jcpds::get_hkl
	return,*self.preflection
end

;for a0,b0,c0

function jcpds::get_a0
	return, self.a0
end
function jcpds::get_b0
	return, self.b0
end
function jcpds::get_c0
	return, self.c0
end

pro jcpds::set_a0,new
	self.a0=new
end

pro jcpds::set_b0,new
	self.b0=new
end
pro jcpds::set_c0,new
	self.c0=new
end